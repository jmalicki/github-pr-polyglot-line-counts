...
describe('Error Handling', () => {
  it('should handle rate limit error gracefully', () => {
    ...
    const mockRateLimitResponse = {
      message: "API rate limit exceeded for 135.180.63.98. (But here's the good news: Authenticated requests get a higher rate limit. Check out the documentation for more details.)",
...
describe('API Response Validation', () => {
  it('should detect rate limit in response', () => {
    ...
    const isRateLimit = rateLimitResponse.message && 
                       rateLimitResponse.message.includes('rate limit');
  ...
  it('should detect valid file response', () => {
    ...
    const isValid = validFile.filename && 
                   typeof validFile.additions === 'number';
